...
scoreboard.geometry('1000x450')
homeFoulsLabel.config(font=('Century Gothic', 75))
guestFoulsLabel.config(font=('Century Gothic', 75))
homeFoulsNameLabel.config(font=('Century Gothic', 25))
guestFoulsNameLabel.config(font=('Century Gothic', 25))
scoreboard.minsize(1000, 450)
